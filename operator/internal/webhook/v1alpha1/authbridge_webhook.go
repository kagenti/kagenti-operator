...
// +kubebuilder:webhook:path=/mutate-workloads-authbridge,mutating=true,failurePolicy=fail,sideEffects=None,groups="",resources=pods,verbs=create,versions=v1,name=inject.rossoctl.io,admissionReviewVersions=v1,reinvocationPolicy=IfNeeded
