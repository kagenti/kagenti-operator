...
#
# Services:
#   1. rossoctl-controller-manager (operator)
...
echo ""
echo "==> Building rossoctl-operator image"
...
# These pin namespace rossoctl-system and include the OAuth-callback HTTPRoute
