...
produces PR #3. Encodes CI best practices: lint, test, build,
...
Use the org reusable workflow if available, or `actions/stale`:
...
SHAs from the upstream action repositories. All
